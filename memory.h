...
int addToMemory(int pageNum, int pid, int policy, doubleLL* tlb, \
        doubleLL* pageTable, node* frameBuffer[], doubleLL* virtualMemory, struct tracefileStat tracefileTracker[]);
