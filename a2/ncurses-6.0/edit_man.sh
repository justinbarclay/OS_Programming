...
(*.[0-9]*)
	...
	if test ! -f /Users/Justin/Dropbox/University/cmput379/assignments/OSystems/a2/ncurses-6.0/man_alias.sed ; then
cat >>/Users/Justin/Dropbox/University/cmput379/assignments/OSystems/a2/ncurses-6.0/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /Users/Justin/Dropbox/University/cmput379/assignments/OSystems/a2/ncurses-6.0/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /Users/Justin/Dropbox/University/cmput379/assignments/OSystems/a2/ncurses-6.0/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	...
	sed	-f /Users/Justin/Dropbox/University/cmput379/assignments/OSystems/a2/ncurses-6.0/man_alias.sed \
		< $i >$TMP
